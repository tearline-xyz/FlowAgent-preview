...
const ContentRender = memo(
  ({
    ...
    return (
      ...
      >
        {isLatestCard && (
          <div id={'absoluteBoxxx'} className="absolute right-0 top-0 m-2 h-3 w-3 rounded-full bg-text-primary" />
        )}
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <div id={'flex_max-w-full_flex-grow_flex-col_gap-0'} className="flex max-w-full flex-grow flex-col gap-0">
              <ContentParts
                edit={edit}
                isLast={isLast}
                enterEdit={enterEdit}
